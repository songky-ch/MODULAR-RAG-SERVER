...
def _register_builtin_providers() -> None:
    ...
    # Financial-report-aware splitter (does not depend on langchain)
    try:
        from src.libs.splitter.financial_report_splitter import FinancialReportSplitter
        SplitterFactory.register_provider("financial", FinancialReportSplitter)
    except ImportError:
        # Optional: only available when source file is present
        pass
