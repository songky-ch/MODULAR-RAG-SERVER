...
class OpenAIEmbedding(BaseEmbedding):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.api_key = api_key or settings.embedding.api_key or os.environ.get("OPENAI_API_KEY")
        if not self.api_key:
            raise ValueError(
        ...
        settings_endpoint = getattr(settings.embedding, "endpoint", None)
        settings_base_url = getattr(settings.embedding, "base_url", None)
        self.base_url = base_url or settings_endpoint or settings_base_url or self.DEFAULT_BASE_URL
